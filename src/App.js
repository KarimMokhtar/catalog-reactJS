...
class App extends Component {
    ...
    renderProducts() {
        let prodeuctsAPI = "https://test-api.edfa3ly.io/product?",
            anotherFilter = "";
        ...
        return <Products categoryName={this.state.currentCategoryName} prodeuctsAPI={prodeuctsAPI} currentCategory={this.state.currentCategory} rate={this.state.rate} color={this.state.color} />;
    }
    render() {
        const categoryAPI = "https://test-api.edfa3ly.io/category";
        return (
            <div className="App">
